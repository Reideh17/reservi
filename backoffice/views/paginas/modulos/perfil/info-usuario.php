		...
		<div class="card-body box-profile">
			...
			<div class="text-center">
				...
				<?php if ($usuario["usufoto"] == "") : ?>
					...
					<img class="profile-user-img img-fluid img-circle" src="<?php echo $ruta ?>backoffice/views/img/usuarios/default/default.png">

				<?php else : ?>

					<img class="profile-user-img img-fluid img-circle" src="<?php echo $usuario["usufoto"] ?>">
			...
			<h3 class="profile-username text-center">
				...
				<?php echo $usuario["usudescrip"] ?>

			</h3>

			<p class="text-muted text-center">

				<?php echo $usuario["usuemail"] ?>
    ...
    <div class="modal-content">
    	...
    	<form method="post" enctype="multipart/form-data">
	      ...
	      <div class="modal-body">
	      	...
	      	<input type="hidden" name="idUsuarioFoto" value="<?php echo $usuario["oid"] ?>">
	        
			<div class="form-group">
				
				<input type="file" class="form-control-file border" name="cambiarImagen" required>

				<input type="hidden" name="fotoActual" value="<?php echo $usuario["usufoto"] ?>">
		...
		<?php
			...
			$cambiarImagen = new UserController();
    ...
    <div class="modal-content">
    	...
    	<form method="post">
	      ...
	      <div class="modal-body">
	      	...
	      	<input type="hidden" name="idUsuarioPassword" value="<?php echo $usuario["oid"] ?>">
		...
		<?php
			...
			$cambiarPassword = new UserController();
