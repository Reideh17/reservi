<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="inicio" class="brand-link">
    <img src="views/img/plantilla/icono.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        ...
        <?php if ($usuario["usufoto"] == "") : ?>
          ...
          <img src="views/img/usuarios/default/default.png" class="img-circle elevation-2" alt="User Image">
      ...
      ======================================-->
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="inversion" class="nav-link">
